...
function knapsack(vehicles, budget) {
  ...
  return {
    ...
    totalHoursUsed: selected.reduce((sum, v) => sum + v.Duration, 0),
  };
}
...
function runScheduler() {
  ...
  DEPOTS.forEach((depot) => {
    ...
    console.log(`     Hours Used        : ${result.totalHoursUsed} / ${depot.MechanicHours}`);
  ...
  console.log(`\n══════════════════════════════════════════════════════════`);
  console.log(`  Grand Total Impact Across All Depots: ${grandTotalImpact}`);
  console.log(`══════════════════════════════════════════════════════════\n`);
}
